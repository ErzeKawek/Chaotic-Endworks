package net.erzekawek.chaoticendworks.world.features;
...
import net.erzekawek.chaoticendworks.world.features.configurations.StructureFeatureConfiguration;
...
public class StructureFeature extends Feature<StructureFeatureConfiguration> {
	public static final DeferredRegister<Feature<?>> REGISTRY = DeferredRegister.create(Registries.FEATURE, ChaoticEndworksMod.MODID);
